...
var _Ruler2 = interopRequireDefault(_Ruler);
    ...
    value: function load(text, timeout) {
      ...
      return new Promise(function (resolve, reject) {
        if (FontFaceObserver.supportsNativeFontLoading() && !FontFaceObserver.hasSafari10Bug()) {
          ...
          (0, _dom.onReady)(function () {
            var rulerA = new _Ruler2.default(testString);
            var rulerB = new _Ruler2.default(testString);
            var rulerC = new _Ruler2.default(testString);
...
FontFaceObserver.Ruler = _Ruler2.default;
