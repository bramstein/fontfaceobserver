describe("Observer", function() {
  ...
  describe("#getStyle", function() {
    it("creates the correct default style", function() {
      ...
      if (FontFaceObserver.supportStretch()) {
        expect(
          observer.getStyle("sans-serif"),
          "to equal",
          "normal normal normal 100px sans-serif"
        );
      } else {
        expect(
          observer.getStyle("sans-serif"),
          "to equal",
          "normal normal  100px sans-serif"
        );
      }
    });
    ...
    it("passes through all descriptors", function() {
      ...
      if (FontFaceObserver.supportStretch()) {
        expect(
          observer.getStyle("sans-serif"),
          "to equal",
          "italic bold condensed 100px sans-serif"
        );
      } else {
        expect(
          observer.getStyle("sans-serif"),
          "to equal",
          "italic bold  100px sans-serif"
        );
      }
    });
  });
  ...
  describe("#load", function() {
    ...
    //   var observer = new FontFaceObserver("sans-serif", {});
    ...
    //   var observer = new FontFaceObserver("serif", {});
  ...
  describe("hasSafari10Bug", function() {
    ...
    beforeEach(function() {
      ...
      getNavigatorVendor = sinon.stub(FontFaceObserver, "getNavigatorVendor");
      supportsNativeFontLoading = sinon.stub(
        FontFaceObserver,
        "supportsNativeFontLoading"
      );
    });
